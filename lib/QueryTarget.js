class QueryTarget {
  ...
  equalTo(queryTarget) {
    return (
      this.isValid &&
      this.targetString === queryTarget.targetString &&
      this._isRectEqual(this.targetClientRect, queryTarget.targetClientRect)
    );
  }
  ...
  toString() {
    return `${this.targetString} time: ${this.createdTime}, rect: ${
      this.targetClientRect && this.targetClientRect.toString()
    }`;
  }
